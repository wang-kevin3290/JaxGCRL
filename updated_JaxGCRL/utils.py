...
def create_parser():
    ...
    parser.add_argument('--clean_jax_arch', type=int, default=0, help="Whether to use clean JAX architecture")
    parser.add_argument('--sac', default=False, help="Whether to use SAC (doesn't affect code, but need it for flagging in wandb, the SAC code automatically sets this to True)")
    return parser
