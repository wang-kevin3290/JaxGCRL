...
def main(args):
    ...
    run_dir = './runs/run_{name}'.format(name=run_name)
...
if __name__ == "__main__":
    ...
    run_name = f"{args.env_name}_{args.num_timesteps}_depth:{args.n_hidden}_skip:{args.skip_connections}_seed:{args.seed}"
