...
if __name__ == "__main__":
    ...
    run_name = f"SAC_{args.env_name}_{args.num_timesteps}_depth:{args.n_hidden}_width:{args.h_dim}_skip:{args.skip_connections}_cleanJax:{args.clean_jax_arch}_seed:{args.seed}"
