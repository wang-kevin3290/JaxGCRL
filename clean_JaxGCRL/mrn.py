...
experiments = [
    ...
    ("expl-env", "ant_big_maze", "ant_big_maze_eval", "100000000", "100"),
    ("expl-env", "ant_u4_maze", "ant_u4_maze_eval", "100000000", "100"),
    ("expl-env", "ant_u5_maze", "ant_u5_maze", "400000000", "400"),
    ("expl-env", "ant_hardest_maze", "ant_hardest_maze", "200000000", "200"),
...
for _ in range(num_seeds):
    for exp in experiments:
        for depth in depths_list:
            for mrn_K in mrn_K_list:
                exp_pass = (exp[1], exp[2], depth, exp[4], exp[3], mrn_K, exp[0])
                # print(exp_pass)
                subprocess.run(["sbatch", f"mrn.slurm", *exp_pass], check=True)
